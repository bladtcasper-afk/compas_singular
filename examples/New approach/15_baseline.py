...
def check_poles():
    ...
    """
    from compas_singular.framefield.quality import HARD_MIN_ANGLE, face_angles, mesh_quality
    from compas_singular.framefield.quality import _face_edges
...
def check_corners():
    ...
    """
    from compas_singular.framefield.background import _densify_loop
    from compas_singular.framefield.repair import SHARP_TURN, boundary_corners
    from compas.geometry import angle_vectors, subtract_vectors
    from compas_singular.framefield.repair import _arc_lengths
