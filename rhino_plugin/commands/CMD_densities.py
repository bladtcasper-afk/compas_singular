...
# One implementation, shared with CMD_quad_mesh -- see density_common.
from density_common import apply_densities, edge_key, get_densities
from density_common import set_densities, strip_edge_map
