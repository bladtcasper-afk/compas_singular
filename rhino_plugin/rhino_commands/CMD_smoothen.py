...
from compas_singular.rhino.helpers.helpers import bake_mesh, clean_layer
...
if mode == "whole":
    ...
    algorithm = rs.GetString(message="Select smoothing method", defaultString="Area",
                             strings=["Area", "Centroid", "CenterOfMass"])
    ...
    layer = {"area": "Area", "centroid": "Centroid",
             "centerofmass": "CenterOfMass"}[algorithm]
    rs.AddLayer(layer, parent="Smoothened")
    clean_layer(layer, clean_sublayers=True)
